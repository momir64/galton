...
ballNumberSlider = Slider(screen, 60, 100, 330, 12, min=1, max=450, initial=41, colour=GRAY3, handleColour=GRAY4)
ballRadiusSlider = Slider(screen, 60, 200, 330, 12, min=4, max=19, initial=8, colour=GRAY3, handleColour=GRAY4)
pegRadiusSlider = Slider(screen, 60, 300, 330, 12, min=4, max=19, initial=10, colour=GRAY3, handleColour=GRAY4)
