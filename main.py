...
text5, textRect5 = font2.render("Koeficijent gravitacije", WHITE, GRAY1)
...
ballNumberSlider = Slider(screen, 60, 100, 330, 12, min=1, max=450, initial=42, colour=GRAY3, handleColour=GRAY4)
ballRadiusSlider = Slider(screen, 60, 200, 330, 12, min=4, max=19, initial=11, colour=GRAY3, handleColour=GRAY4)
pegRadiusSlider = Slider(screen, 60, 300, 330, 12, min=4, max=19, initial=13, colour=GRAY3, handleColour=GRAY4)
...
restitutionSlider = Slider(screen, 60, 600, 330, 12, min=0, max=1, initial=0.33, step=0.01, colour=GRAY3, handleColour=GRAY4)
